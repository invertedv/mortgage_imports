INSERT INTO fannie.n3sted
      SELECT
            ...
            max(ln_nonstd_doc_flg) AS ln_nonstd_doc_flg,
            max(ln_nonstd_uw_flg) AS ln_nonstd_uw_flg,
            max(ln_govt_guar_flg) AS ln_govt_guar_flg,
            max(ln_negam_flg) AS ln_negam_flg,
